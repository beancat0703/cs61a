    ...
    def double(self):
        ...
        while current_place is not None:
            if current_place.ant:
                if current_place.ant.is_doubled is False:
                    current_place.ant.damage *= 2
                    current_place.ant.is_doubled = True
                if current_place.ant.is_container and current_place.ant.ant_contained is not None and current_place.ant.ant_contained.is_doubled is False:
                    current_place.ant.ant_contained.damage *= 2
                    current_place.ant.ant_contained.is_doubled = True
